 ...
 */
public class RepeatButtonWhite extends ImageButton implements OnClickListener, OnLongClickListener {

    /**
     * Repeat one theme resource
     */
    private static final String REPEAT_ALL = "btn_playback_repeat";
     ...
     * Repeat one theme resource
     */
    private static final String REPEAT_NONE = "btn_playback_repeat_all";
    ...
    public RepeatButtonWhite(final Context context, final AttributeSet attrs) {
        super(context, attrs);
