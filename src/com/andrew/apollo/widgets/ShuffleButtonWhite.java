 ...
 */
public class ShuffleButtonWhite extends ImageButton implements OnClickListener, OnLongClickListener {
    ...
    public ShuffleButtonWhite(final Context context, final AttributeSet attrs) {
        super(context, attrs);
