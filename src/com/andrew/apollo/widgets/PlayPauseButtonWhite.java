 ...
 */
public class PlayPauseButtonWhite extends ImageButton implements OnClickListener, OnLongClickListener {

    /**
     * Play button theme resource
     */
    private static final String PLAY = "btn_playback_play_white";

    /**
     * Pause button theme resource
     */
    private static final String PAUSE = "btn_playback_pause_white";
    ...
    public PlayPauseButtonWhite(final Context context, final AttributeSet attrs) {
        super(context, attrs);
